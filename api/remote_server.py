...
def check_update():
    ...
    :return:
    """
    url = "https://passport.chwm.vip/Rainbow/Update/WXKey/Config/Upgrade.txt"
    try:
        import requests
        ...
        if res.status_code == 200:
            ...
            return ReJson(0, body={"msg": msg, "latest_version": NEW_VERSION,
                                   "latest_url": "https://passport.chwm.vip/Rainbow/Update/WXKey/Config/" + NEW_VERSION})
        else:
...
def get_readme():
    ...
    :return:
    """
    url = "https://raw.githubusercontent.com/RainbowNetworkTechnology/WeChatKey/refs/heads/main/README.md"
    import requests
    res = requests.get(url)
    if res.status_code == 200:
        data = res.text
        data = data.replace("# <center>Rainbow WeChatKey Tools</center>", "")
