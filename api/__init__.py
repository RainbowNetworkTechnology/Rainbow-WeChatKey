...
def gen_fastapi_app(handler, origins=None):
    app = FastAPI(title="wxdump", description="微信Key工具", version=__version__,
                  terms_of_service="https://blog.csdn.net/qq_39190622/category_12825531.html",
                  contact={"name": "Rainbow", "url": "https://www.chwm.vip/index.html?a=contact"},
                  license_info={"name": "MIT License",
                                "url": "https://www.chwm.vip/index.html?aid=23"})
